...
var transcriptIgnoredEvents = map[string]string{
	...
	"bash_execution_update":             "bash subprocess telemetry is represented by the owning tool execution entry",
	...
	"summarization_retry_attempt_start": "summarization retry telemetry is not part of Neo's transcript projection",
	"summarization_retry_scheduled":     "summarization retry telemetry is not part of Neo's transcript projection",
	"summarization_retry_finished":      "summarization retry telemetry is not part of Neo's transcript projection",
