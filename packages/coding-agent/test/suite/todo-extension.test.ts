...
describe("todo extension", () => {
	...
	it("centers a long sidebar window on recent progress and upcoming work", () => {
		const phases: TodoPhase[] = [
			{
				name: "Review",
				tasks: [
					...
					{ content: "Completed 5", status: "completed" },
					{ content: "Completed 6", status: "completed" },
					{ content: "Current task", status: "in_progress" },
					{ content: "Upcoming 1", status: "pending" },
					{ content: "Upcoming 2", status: "pending" },
					{ content: "Upcoming 3", status: "pending" },
					{ content: "Upcoming 4", status: "pending" },
					{ content: "Upcoming 5", status: "pending" },
				],
			},
		];

		expect(getTodoWidgetLines(phases)).toEqual([
			"Todo",
			"Review",
			"... (4 earlier tasks)",
			"[✓] Completed 5",
	...
	it("uses the active phase as the bounded sidebar window", () => {
		const phases: TodoPhase[] = [
			{
				name: "Closed phase",
				tasks: [
					{ content: "Closed 1", status: "completed" },
					{ content: "Closed 2", status: "completed" },
				],
			},
			{
				name: "Delivery",
				tasks: [
					{ content: "Delivery done 1", status: "completed" },
					{ content: "Delivery done 2", status: "completed" },
					{ content: "Delivery done 3", status: "completed" },
					{ content: "Ship now", status: "in_progress" },
					{ content: "Verify 1", status: "pending" },
					{ content: "Verify 2", status: "pending" },
					{ content: "Verify 3", status: "pending" },
					{ content: "Verify 4", status: "pending" },
					{ content: "Verify 5", status: "pending" },
					{ content: "Verify 6", status: "pending" },
				],
			},
			{ name: "Later phase", tasks: [{ content: "Publish", status: "pending" }] },
		];
