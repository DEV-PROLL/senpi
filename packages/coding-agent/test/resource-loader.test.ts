...
Project skill content`,
	...
	describe("system prompt sources", () => {
		it("does not discover project SYSTEM.md as the system prompt source", async () => {
		...
		it("does not discover global SYSTEM.md as the system prompt source", async () => {
		...
		it("does not discover APPEND_SYSTEM.md as an append system prompt source", async () => {
			const piDir = join(cwd, ".pi");
