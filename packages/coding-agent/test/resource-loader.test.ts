...
Project skill content`,
	...
	describe("system prompt sources", () => {
		it("does not expose discovered project SYSTEM.md as a system prompt source", async () => {
		...
		it("does not expose discovered global SYSTEM.md as a system prompt source", async () => {
