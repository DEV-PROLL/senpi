...
import {
	...
	type ClaudeAgentSdkQueryOptionsInput,
...
function optionsFor(
	...
	providerSettings: ClaudeAgentSdkQueryOptionsInput["providerSettings"] = {},
) {
	return buildClaudeAgentSdkQueryOptions({
		model: model(),
...
function appendOf(queryOptions: ReturnType<typeof buildClaudeAgentSdkQueryOptions>): string {
...
describe("Claude Agent SDK project instructions forwarding", () => {
...
describe("Claude Agent SDK project instructions round-trip", () => {
