...
- Fixed file-backed `SYSTEM.md` and `APPEND_SYSTEM.md` prompts being shown in the interactive startup context listing when explicit prompt files are configured. See [System Prompt Files](docs/usage.md#system-prompt-files) ([#7096](https://github.com/earendil-works/pi/issues/7096)).
...
- Fixed inherited Qwen Token Plan reasoning models to send service-specific thinking controls and supported reasoning-effort levels ([#6951](https://github.com/earendil-works/pi/issues/6951), [#6998](https://github.com/earendil-works/pi/issues/6998)).
