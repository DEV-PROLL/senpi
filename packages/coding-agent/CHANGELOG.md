...
- Claude SDK OAuth no longer publishes a continuity binding for a locally minted SDK session id until `system/init` confirms it, preventing repeated resume failures after a cold-seed error ([oh-my-openagent#7562](https://github.com/code-yeongyu/oh-my-openagent/issues/7562)).
