...
export const workspaceSourcePaths = {
	...
	aiProviderScope: fileURLToPath(new URL("./packages/ai/src/node/provider-scope.ts", import.meta.url)),
	...
	ptyIndex: fileURLToPath(new URL("./packages/pty/src/index.ts", import.meta.url)),
...
export default defineConfig({
	resolve: {
		alias: [
			...
			{ find: /^@earendil-works\/pi-ai\/node\/provider-scope$/, replacement: workspaceSourcePaths.aiProviderScope },
			...
			{ find: /^@earendil-works\/pi-pty$/, replacement: workspaceSourcePaths.ptyIndex },
