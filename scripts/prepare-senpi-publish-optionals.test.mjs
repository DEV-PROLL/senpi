...
it("accepts consumer-resolved platform optionals outside the packed bundle", () => {
	...
	const packed = {
		files: [
			...
			{ path: "package/node_modules/@earendil-works/pi-client/package.json" },
			{ path: "package/node_modules/@earendil-works/pi-client/dist/index.js" },
			{ path: "package/node_modules/@earendil-works/pi-protocol/package.json" },
			{ path: "package/node_modules/@earendil-works/pi-protocol/dist/index.js" },
