...
Portions of the system prompt in `packages/coding-agent/src/core/dynamic-prompt/style.ts`
(Execution Stance and Scope of Freedom sections) are adapted from
[Gajae-Code](https://github.com/nicepkg/gajae-code), which is MIT-licensed:
