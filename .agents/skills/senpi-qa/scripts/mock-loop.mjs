...
if (argv[0] === "--self-test") {
	...
	process.stderr.write(
		[
			...
			"  node mock-loop.mjs --scenario <transient-recover|budget-exhaust|server-error-fallback|long-retry-after|billing-swap|anthropic-policy-refusal-fallback> [--api <name>]",
